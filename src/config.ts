  ...
  experience: [
    {
      ...
      bullets: [
        "Desenvolvendo NextBlog, um blog moderno com Next.js, autenticação e CMS integrado.",
        "Criando EcommerceNext, e-commerce completo.",
        "Desenvolvendo Nexus SixTech, site de vendas de jogos com dashboard, gráficos e controle de estoque.",
        "Criei o 4Players, site interativo para gamers.",
        "Portfólio profissional com versões em Astro + Tailwind, publicado online.",
        "Experimentando no projeto Astro-Projects, explorando Astro, Tailwind, Motion e componentes reativos.",
        "Implementação do jogo Xadrez Console em C#, aplicando POO e lógica de movimentação.",
      ],
    },
    {
