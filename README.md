...
![Astro](https://img.shields.io/badge/Astro-ff5f5f?style=for-the-badge&logo=astro&logoColor=white)
...
1. Faça alterações nos arquivos do projeto local (HTML, CSS, componentes Astro).  
2. Rode `npm run build` para gerar a pasta `dist`.  
3. Copie os arquivos da `dist` para o branch de deploy.  
4. Faça commit e push para atualizar o site online.
